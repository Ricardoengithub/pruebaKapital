...
const WeatherChart: React.FC<Props> = ({ data }) => {
  const [metric, setMetric] = useState<'temperature' | 'humidity' | 'wind' | 'pressure' | 'clouds' | 'rain'>('temperature');
  ...
  return (
    <Box mt={5}>
      ...
      >
        ...
        <ToggleButton value="pressure">📊 Presión</ToggleButton>
        <ToggleButton value="clouds">☁️ Nubes</ToggleButton>
        <ToggleButton value="rain">🌧️ Lluvia</ToggleButton>
      </ToggleButtonGroup>
